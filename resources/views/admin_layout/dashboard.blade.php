                    ...
                    <div class="hover-scroll-overlay-y my-2 py-5 py-lg-8" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                            ...
                            {{-- @if (Auth()->user()->hak_akses != 2) --}}
                                <div class="menu-item">
                                    <a class="menu-link {{ Request::is('/admin_index')?'active' : '' }}" href="{{ route('admin_index') }}">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link {{ Request::is('/employee_management')?'active' : '' }}" href="{{ route('employee_management') }}">
                                        <span class="menu-icon">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link {{ Request::is('/user_management')?'active' : '' }}" href="{{ route('user_management') }}">
                                        <span class="menu-icon">
