                    ...
                    <div class="hover-scroll-overlay-y my-2 py-5 py-lg-8" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                            ...
                            {{-- @if (Auth()->user()->hak_akses != 2) --}}
                                <div class="menu-item">
                                    <a class="menu-link {{ Request::is('DashboardProfile')?'active' : '' }}" href="/DashboardProfile">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link {{ Request::is('OutgoingMail')?'active' : '' }}" href="/OutgoingMail">
                                        <span class="menu-icon">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link {{ Request::is('Report')?'active' : '' }}" href="/Report">
                                        <span class="menu-icon">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link {{ Request::is('Reference')?'active' : '' }}" href="/Reference">
                                        ...
                                        <span class="menu-title">Kode Klaisifkasi</span>
                                    </a>
                                </div>
